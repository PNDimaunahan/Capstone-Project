            ...
            <div class="page-breadcrumb mb-3">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Customer Details</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Dashboard</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Customer Details</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"> In here the user (you), can view the customer details for
                                business purposes.</h6>
                                    ...
                                    <table id="default_order" class="table border table-striped table-bordered text-nowrap"
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $sql = "SELECT u.customer_id, u.first_name, u.last_name, u.address, u.email FROM tbl_customer u";
