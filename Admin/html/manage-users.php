<?php
    ...
    if(isset($_GET['update']) && $_GET['update'] === 'success') {
        $updateMessage = "You have successfully updated the user.";
    }
?>
                    ...
                    <div class="modal-content modal-filled bg-success">
                        <div class="modal-body p-4">
                            <div class="text-center">
                                <h4 class="mt-2 text-white">Updated successfully</h4>
                                <p class="mt-3 text-white">' . $updateMessage . '</p>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Manage Users</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"> In here the user (you), can view, and disable the inactive accounts of the customer or the staff for security and privacy purposes.</h6>
                                    ...
                                    <table id="default_order" class="table border table-striped table-bordered text-nowrap" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $sql = "SELECT u.user_id, u.user_name, t.user_type
                                                    FROM tbl_user u
                                                    INNER JOIN tbl_user_type t ON u.user_type_id_fk = t.user_type_id";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="user-list-edit.php?user_id=<?php echo $row['user_id']; ?>" class="btn waves-effect waves-light btn-rounded btn-primary">Edit</a>
