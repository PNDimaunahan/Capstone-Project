            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">E-Invoice</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Dashboard</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">E-Invoice</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">E-Invoice</h4>
                                <h6 class="card-subtitle mb-3">In here the user (you), can view the E-invoice.</h6>
                                <button onclick="printPage()"  class="btn waves-effect waves-light btn-rounded btn-success">Print</button>
                                <br> <br>
                                    ...
                                    <table id="default_order" class="table border table-striped table-bordered text-nowrap"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                Complete</td>
                                                <td>
                                                <a href="e-invoice-view.php" class="btn waves-effect waves-light btn-rounded btn-primary">View Details</a>
                                            </td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>23 </td>
                                                <td>2024-04-25</td>
                                                <td>Sureguard, Medical Gloves</td>
                                                <td>
                                                Complete</td>
                                                <td>
                                                <a href="e-invoice-view.php" class="btn waves-effect waves-light btn-rounded btn-primary">View Details</a>
