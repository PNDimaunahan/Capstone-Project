                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="account.php" data-bs-toggle="dropdown"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-3">In here the user (you), can view, and disable the inactive accounts of the customer or the staff for security and privacy purposes.</h6>
                                <h6 class="card-subtitle mb-4"><a type="button" class="btn waves-effect waves-light btn-success" href="product-list-add.php">Add a product</a></h6>
                                    ...
                                    <table id="default_order" class="table border table-striped table-bordered text-nowrap"
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $sql = "SELECT p.productid, p.name, p.description, p.price, t.SizeName, p.expirydate, a.TypeName, p.product_image 
                                                    FROM tbl_product p
                                                    INNER JOIN tbl_product_size t ON p.SizeID = t.SizeID
                                                    INNER JOIN tbl_product_type a ON p.TypeID = a.TypeID;";
                                                try {
                                                    ...
                                                    header("location: ../product-list.php?error=sqlerror");
                                                    exit();
                                                }
                                                ...
                                                ?>
                                                <tr>
                                                    <td style="white-space: pre-line;"><?php echo $row['productid'] ?></td>
                                                    <td style="white-space: pre-line;"><?php echo $row['name'] ?></td>
                                                    <td style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px;"><?php echo $row['description'] ?></td>
                                                    <td style="white-space: pre-line;"><?php echo $row['price'] ?></td>
                                                    <td style="white-space: pre-line;"><?php echo $row['SizeName'] ?></td>
                                                    <td style="white-space: pre-line;"><?php echo $row['expirydate'] ?></td>
                                                    <td style="white-space: pre-line;"><?php echo $row['TypeName'] ?></td>
                                                    <td><img src="<?php echo $basePath . $row['product_image']; ?>" alt="Product Image" style="max-width: 100px; max-height: 100px;"></td>

                                                    <td>
                                                        <a href="product-list-edit.php?product_id=<?php echo $row['productid']; ?>" class="btn waves-effect waves-light btn-rounded btn-primary">Edit</a>
                                                        <a type="button" class="btn waves-effect waves-light btn-rounded btn-danger">Archive</a>
                                                    </td>
                                                </tr>
                                                <?php
                                                }
