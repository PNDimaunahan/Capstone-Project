...
<head>
    ...
    <title>Refund and Exchange</title>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        ...
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Refund and Exchanges</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Dashboard</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Refund and Exchanges</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Refund and Exchanges</h4>
                <h6 class="card-subtitle mb-3">In here the user (you), can approve or decline refund of the customers</h6>
                    ...
                    <table id="default_order" class="table border table-striped table-bordered text-nowrap" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Processing</td>
                                <td>
                                    <button type="button" class="btn waves-effect waves-light btn-rounded btn-success">Approve Refund</button>
                                    <button type="button" class="btn waves-effect waves-light btn-rounded btn-danger">Decline Refund</button>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
