            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Customer Order</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Dashboard</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Order Purchasing</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Order Purchasing</h4>
                                <h6 class="card-subtitle mb-3">In here the user (you), can view and edit the order that the customer orders in the e-commerce website.</h6>
                                    ...
                                    <table id="default_order" class="table border table-striped table-bordered text-nowrap"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <button type="button" class="btn waves-effect waves-light btn-rounded btn-danger">Disable</button></td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>Garrett </td>
