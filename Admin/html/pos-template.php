...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="https://www.restock.com.au/productimages/652201B.jpg" class="card-img-top" alt="Product 1">
                    <div class="card-body">
                        <h5 class="card-title">Product 1</h5>
                        <p class="card-text">Description for Product 1</p>
                        <button class="btn btn-primary add-to-cart" data-product-id="2">Add to POS</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="https://www.restock.com.au/productimages/652201B.jpg" class="card-img-top" alt="Product 2">
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="https://www.restock.com.au/productimages/652201B.jpg" class="card-img-top" alt="Product 3">
                    <div class="card-body">
                        <h5 class="card-title" src = >Product 3</h5>
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="https://www.restock.com.au/productimages/652201B.jpg" class="card-img-top" alt="Product 4">
                    <div class="card-body">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="https://www.restock.com.au/productimages/652201B.jpg" class="card-img-top" alt="Product 5">
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="https://www.restock.com.au/productimages/652201B.jpg" class="card-img-top" alt="Product 6">
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="https://www.restock.com.au/productimages/652201B.jpg" class="card-img-top" alt="Product 7">
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="https://www.restock.com.au/productimages/652201B.jpg" class="card-img-top" alt="Product 8">
                    <div class="card-body">
