...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    require 'db.handler.inc.php';
      ...
      $query_check = "SELECT * FROM tbl_customer WHERE user_id_fk = ?";
      ...
      if ($existingData) {
        ...
        $query_update = "UPDATE tbl_customer SET first_name = ?, last_name = ?, email = ?, address = ?, user_type_id_fk = ? WHERE user_id_fk = ?";
        ...
        // Insert new user data into tbl_customer
        $query_insert = "INSERT INTO tbl_customer (user_id_fk, first_name, last_name, email, address, user_type_id_fk) VALUES (?, ?, ?, ?, ?, ?)";
