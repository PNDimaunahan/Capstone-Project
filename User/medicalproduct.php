    ...
    <div class="container py-4">
      ...
      <nav class="d-flex mb-2">
        <h6 class="mb-0">
          ...
          <span class="text-white-50 mx-2"> > </span>
          <a href="medicalproduct.php" class="text-white"><u>Medical Products</u></a>
        </h6>
      </nav>
      <!-- Breadcrumb -->
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-9" style="margin-top: 60px;">
        <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
          <?php
          $sql = "SELECT COUNT(*) AS item_count FROM tbl_product WHERE typeid = 1";
          $stmt = $pdo->query($sql);
...
<div class="row justify-content-center mb-3" id="productList">
  <div class="col-md-12">
    <?php
      ...
      $sql = "SELECT ProductID, product_image, Name, Price, description FROM tbl_product WHERE typeid = 1 LIMIT $start, $perPage";
      $stmt = $pdo->query($sql);
      ...
      $totalItems = $pdo->query("SELECT COUNT(*) FROM tbl_product WHERE typeid = 1")->fetchColumn();
    ...
    <div class="row">
      ...
      <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
        ...
        <ul class="list-unstyled mb-0">
          <li><a href="product.html" class="text-muted">Products</a></li>
          <li><a href="dentalproduct.html" class="text-muted">Dental Product</a></li>
          <li><a href="medicalproduct.html" class="text-muted">Medical Product</a></li>
        </ul>
      </div>
